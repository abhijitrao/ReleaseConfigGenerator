(() => {
  ...
  function saveConfig(){
    ...
    }else if(editingType==='pfx'){const fileName=$('cfgPfxFileName').value.trim();if(!fileName)return toast('PFX File Name is required');const timestamp=$('cfgPfxTimestamp').value.trim();state.pfxConfig={pfxFileName:fileName,timeStamp:timestamp};
